...
import za.ac.cput.MobilePhones.conf.factory.*;
...
public class CustomerServiceTest extends AbstractTestNGSpringContextTests {
    ...
    public void create() throws Exception {
        ...
        Customer customer = CustomerFactory.createCustomer(NameFactory.createName("Sally", "Lee", "Abrahams"), "Female", "2015-10-13", ContactFactory.createContact("0219807439", "0829431236"), AddressFactory.createAddress("452 Sasol Street", "", "", ""), ordersList, null, null, null, null);
